...
%% Start a connection with the server
    ...
    for i=1:7
            ...
            [res,daHandle]=vrep.simxGetObjectHandle(clientID,s,...
...
jPos={0., pi / 180 * 20., 0., -pi / 180 * 70., 0.,pi / 180 * 90., 0.};                
relVel=0.25;
...
counter=0;
tic;
totalTimeSecs=60; % 60 seconds of execution time, change to 80 later
vrep.simxStartSimulation(clientID,vrep.simx_opmode_oneshot_wait);
% don't forget to pause(20)
for i=1:7
        [res,tempPos]=vrep.simxGetJointPosition(clientID,jHandles(i),...
            vrep.simx_opmode_streaming);
end
vrep.simxWriteStringStream(clientID,'path_velocity','0.07',...
   vrep.simx_opmode_oneshot_wait);
jpos=zeros(7,25000);
t_0=toc;
